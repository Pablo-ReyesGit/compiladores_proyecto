...
public class ReporteHTML {
   ...
   /* public static void agregarSimbolo(String nombre, String tipo, String valor) {
    ...
    public static void generarReporte() {
        generarArchivo("src\\ArchivosHTML\\TOKENS.html", "Tokens_Reconocidos", tokens, "Token", "Valor", "Fila", "Columna");
        generarArchivo("src\\ArchivosHTML\\Errores.html", "Errores_Lexicos", erroresLexicos, "Error");
